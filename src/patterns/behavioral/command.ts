const Command = `
  ...
  дозволяючи передавати їх як аргументи під час виклику методів, ставити запити в чергу, логувати їх, 
  a також підтримувати скасування операцій.

  Це поведінковий патерн, що дозволяє загортати запити або прості операції в окремі об’єкти.
